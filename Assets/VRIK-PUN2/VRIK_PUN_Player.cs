...
namespace RootMotion.Demos
{
    ...
    public class VRIK_PUN_Player : MonoBehaviourPun, IPunObservable, IPunInstantiateMagicCallback
    {
        ...
        public NetworkTransform rootNetworkT = new NetworkTransform();
        public NetworkTransform headNetworkT = new NetworkTransform();
        public NetworkTransform leftHandNetworkT = new NetworkTransform();
        public NetworkTransform rightHandNetworkT = new NetworkTransform();
        ...
        public Transform headIKProxy;
        public Transform leftHandIKProxy;
        public Transform rightHandIKProxy;
